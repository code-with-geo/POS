...
namespace POS
{
    public partial class Tenders : MetroFramework.Forms.MetroForm
    {
        ...
        public Tenders(int userId, int locationId, int customerId, List<Cart> cart)
        {
            InitializeComponent();
            UserId = userId;
        ...
        private void Tenders_KeyDown(object sender, KeyEventArgs e)
        {
        ...
        {
            var digitalPayments = new DigitalPayments(UserId, LocationId, CustomerId, Cart, 1);
            this.Visible = false;
            var result = digitalPayments.ShowDialog();
        ...
        {
            var cash = new Cash(UserId, LocationId, CustomerId, Cart);
            this.Visible = false;
            var result = cash.ShowDialog();
        ...
        {
            var digitalPayments = new DigitalPayments(UserId, LocationId, CustomerId, Cart, 2);
            this.Visible = false;
            var result = digitalPayments.ShowDialog();
        ...
        private async void btnCredit_Click(object sender, EventArgs e)
        {
            //var digitalPayments = new DigitalPayments(UserId, LocationId, CustomerId, Cart, 1);
            //this.Visible = false;
            //var result = digitalPayments.ShowDialog();
            ...
            if (result)
            {
                var print = new PrintReceiptForm(Cart, InvoiceNo, TotalAmount, TotalDiscount, TotalVatSale, TotalVatAmount, TotalVatExempt, 0m, 0m);
                this.Visible = false;
